                ...
                <el-card class="tenant">
                    <div slot="header" class="card_header">
                        ...
                        <div class="card_h_des">
                            <div class="c_h_desc_title">租户</div>
                            <div class="c_h_desc_content">租户总数</div>
                        </div>
                    ...
                    <div class="c_main_c">
                        <div class="tenant_num">
                            <div class="c_normal">
                                <div>2</div>
                                <div class="main_desc">正常</div>
                            </div>
                            <div class="c_abnormal">
                                <div>0</div>
                                <div class="main_desc">异常</div>
                            </div>
                        </div>
            ...
            <el-col :span="8">
                <el-card class="tenant">
                    <div slot="header" class="card_header">
                        ...
                        <div class="card_h_des">
                            <div class="c_h_desc_title">安全服务</div>
                            <div class="c_h_desc_content">安全服务总数</div>
                        </div>
            ...
            <el-col :span="8">
                <el-card class="tenant">
                    <div slot="header" class="card_header">
                        ...
                        <div class="card_h_des">
                            <div class="c_h_desc_title">资源</div>
                            <div class="c_h_desc_content">资源总数</div>
                        </div>
